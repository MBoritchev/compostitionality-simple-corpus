###############################################################################################################################
# This script plots the average Hamming distances for the unseen length experiment, MLP, minimal length of unseen proof = 0. #
###############################################################################################################################
...
def visualisation_fct_average_ham(model):
    x_array = log_triples0()  # contains all possible n1,n2,m triples, defining all existing logs for given model
...
visualisation_fct_average_ham("MLP")
